...
import { getDashboardKPIs, getRecentActivities, getQuickStats, type KPI } from '@/actions/dashboard';
import {
  TrendingUp,
  DollarSign,
  Users,
                ...
                <Card key={kpi.id}>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {kpi.type === 'currency' &&
                        new Intl.NumberFormat('en-PK', { style: 'currency', currency: 'PKR' }).format(kpi.currentValue)
                      }
                      {kpi.type === 'percentage' &&
                    ...
                    <p className="text-xs text-muted-foreground">
                      {kpi.changeType === 'increase' ? '+' : ''}{kpi.change}% from last month
                    </p>
                    <div className="mt-4">
                      <div className="flex justify-between text-sm text-muted-foreground mb-1">
                        <span>
                          Target: {
                            kpi.type === 'currency'
                              ? new Intl.NumberFormat('en-PK', { style: 'currency', currency: 'PKR' }).format(kpi.targetValue)
                              : kpi.type === 'percentage'
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{quickStats.activeProjects || 0}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{quickStats.totalInvoices || 0}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{quickStats.pendingInvoices || 0}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{quickStats.overdueInvoices || 0}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
