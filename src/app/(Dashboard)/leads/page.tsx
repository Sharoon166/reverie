...
export default async function LeadsPage() {
  ...
  if (Array.isArray(empRes)) {
    ...
    const empData = empRes as {
      rows?: Array<{ id?: string; $id?: string; name?: string }>;
    };
  ...
  return (
    <LeadsPageClient
      ...
      quarter={quarter}
      actions={{
        create: createLeadAction as unknown as (
          formData: FormData
        ) => Promise<Lead>,
        update: updateLeadAction as unknown as (
          id: string,
          formData: FormData
        ) => Promise<Lead>,
        remove: deleteLeadAction as unknown as (id: string) => Promise<void>,
        convert: convertLeadToClientAction as unknown as (
          id: string
        ) => Promise<Lead>,
      }}
    />
