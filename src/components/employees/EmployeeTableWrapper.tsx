...
export default function EmployeeTableWrapper({
  ...
  const [deleteDialog, setDeleteDialog] = useState({ open: false, employee: null as Partial<Employee> | null });
  const [editDialog, setEditDialog] = useState({ open: false, employee: null as Partial<Employee> | null });
  const [notesDialog, setNotesDialog] = useState({ open: false, employee: null as Employee | null });
  const [attendanceDialog, setAttendanceDialog] = useState({ open: false, employee: null as Employee | null });
  const [salaryDialog, setSalaryDialog] = useState({ open: false, employee: null as Employee | null });
  ...
  const handleSalarySave = async (data: { month: string; bonusAmount: number }) => {
